          ...
          <ContentSection title="Private Appointments">
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Experience personalized service with a private appointment. Our style consultants will guide you through our collections, help with bespoke options, and provide expert advice in a comfortable, private setting.
              </p>
          ...
          <ContentSection title="Virtual Consultations">
            <div className="bg-muted/10 rounded-lg p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Book a virtual consultation with one of our style experts. We'll showcase pieces via video call,
