      ...
      <div className="flex">
        ...
        <main className="w-full lg:w-[70vw] lg:ml-auto px-6">
          <PageHeader
            ...
            subtitle="Creating beautiful clothing while protecting our planet for future generations"
          />
              ...
              <div className="space-y-6">
                ...
                <AnimatedText animation="fadeUp" delay={0}>
                  <p className="text-muted-foreground leading-relaxed">
                    We partner only with suppliers who share our commitment to ethical practices. Every fabric and material in our collection is sourced responsibly, with full transparency in our supply chain.
                  </p>
                </AnimatedText>
              </div>
              <div className="space-y-6">
                ...
                <AnimatedText animation="fadeUp" delay={0}>
                  <p className="text-muted-foreground leading-relaxed">
                    Over 80% of our fabrics are organic or come from recycled sources, reducing the environmental impact of production while maintaining the highest quality standards for our clothing.
                  </p>
                </AnimatedText>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fadeUp" stagger={0.03} className="space-y-8">
              <AnimatedText animation="fadeUp" delay={0}>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  We believe in the power of circular design - creating clothing that can be treasured, repaired, and eventually recycled into new pieces.
                </p>
              </AnimatedText>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <AnimatedText animation="fadeUp" delay={0}>
                    <p className="text-muted-foreground">
                      When you're ready for something new, we'll take back your Lavender Lily pieces to be recycled into future collections.
                    </p>
                  </AnimatedText>
                </div>
              </div>
